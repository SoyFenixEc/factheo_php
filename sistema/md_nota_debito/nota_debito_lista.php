...
try {
    $sql = "SELECT f.id, f.fecha_emision, f.total, f.estado_xml, f.clave_acceso,
            ...
            WHERE e.usuario_id = ? AND f.tipo_comprobante_id = '05'";
    $params = [$usuario_id];
            ...
            <div id="content">
                ...
                <div id="dynamic-content" class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="nota_debito_nueva.php" class="btn btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Nueva Nota de Débito</a>
                    </div>

                    <?php if ($msg == 'success'): ?>
                        <div class="alert alert-success alert-dismissible"><i class="fas fa-check-circle"></i> Nota de Débito #<?= $nd_id ?> generada correctamente. <button type="button" class="close" data-dismiss="alert">&times;</button></div>
                    <?php endif; ?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-file-invoice"></i> Lista de Notas de Débito</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="nota_debito_ver.php?id=<?= $nc['id'] ?>" class="btn btn-sm btn-primary" title="Ver"><i class="fas fa-eye"></i></a>
                                                        <?php if($nc['estado_xml'] != 'AUTORIZADO' && $nc['emp_activa']): ?>
                                                            <a href="nota_debito_completa.php?id=<?= $nc['id'] ?>" class="btn btn-sm btn-success" title="Autorizar"><i class="fas fa-check"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        ...
                                        <?php else: ?>
                                            <tr><td colspan="12" class="text-center py-4"><i class="fas fa-file-invoice-dollar fa-3x text-gray-300 mb-3 d-block"></i>No hay Notas de Débito.</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
