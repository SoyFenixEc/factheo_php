...
$nd_id = isset($_GET['id']) ? intval($_GET['id']) : 0;
require('../md_config/conexion.php');
$stmt = $pdo->prepare("SELECT f.*, c.razon_social FROM facturas f LEFT JOIN clientes c ON f.cliente_id = c.id WHERE f.id = ? AND f.tipo_comprobante_id = '05'");
$stmt->execute([$nd_id]);
$nc_data = $stmt->fetch(PDO::FETCH_ASSOC);
if (!$nc_data) die("<div class='alert alert-danger'>Nota de Débito no encontrada.</div>");
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div id="dynamic-content" class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">⚡ Autorizar Nota de Débito</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow-sm p-4">
                                ...
                                <input type="hidden" id="nd_id" value="<?= $nd_id ?>">
                                <div class="alert alert-info">
                                    <strong>ID:</strong> <?= $nd_id ?><br>
    ...
    async function ejecutar() {
        ...
        try {
            ...
            const r1=await fetch('nota_debito_generar_xml_1_1_0.php?id='+id);
            ...
            document.getElementById('resultado').innerHTML+='<div class="alert alert-success mt-3"><strong>Nota de Débito AUTORIZADA</strong><br>Número de autorización: '+d4[2]+'</div>';
            Swal.fire({title:'Proceso completado',text:'Nota de Débito autorizada correctamente',icon:'success'});
