...
<head>
    ...
    <title>Nota de Crédito Nueva</title>
    <style>
...
<body>
            ...
            <div id="content">
                ...
                <div id="dynamic-content" class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Crear Nota de Crédito</h1>
                    </div>
                    ...
                    <form action="nota_credito_graba.php" method="POST" id="notaCreditoForm">
                        <input type="hidden" id="factura_sustento_id_val" name="factura_sustento_id" value="">
                        <input type="hidden" id="cliente_id" name="cliente_id" value="">

                        <div class="card shadow mb-4">
                            <div class="card-header py-3"><h6 class="m-0 font-weight-bold text-primary">Datos de la Nota de Crédito</h6></div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg mb-4">Generar Nota de Crédito</button>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $('#notaCreditoForm').on('submit', function(e) {
