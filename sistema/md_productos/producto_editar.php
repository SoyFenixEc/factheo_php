                        ...
                        <div class="col-lg-6">
                            <form action="producto_actualiza.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="foto" id="foto" class="form-control" onchange="previewFoto(event)" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp">
                                    ...
                                    <?php if (!empty($producto['foto'])): ?>
                                        <div class="mt-2"><small class="text-muted">Foto actual:</small><br><img src="<?php echo htmlspecialchars($producto['foto']); ?>" alt="Producto" style="max-width: 100px; border-radius: 5px; border: 1px solid #ddd; padding: 2px;"></div>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group">
                                    <label>Bodega</label>
