...
<head>
    ...
    <style>
        ...
        /* Estilos para las pestañas - Bootstrap 4 */
        .nav-tabs {
            border: none;
            justify-content: center;
            margin-bottom: 2rem;
...
<body class="bg-gradient-light">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <!-- Pestañas de navegación - BOOTSTRAP 4 -->
                                            ...
                                            <?php if (isset($_GET['error'])): ?>
                                                ...
                                                switch ($_GET['error']) {
                                                    ...
                                                    case 'contrasena_incorrecta':
                                                        ...
                                                        break;
                                                    case 'error_sesion':
                                                        $mensaje = 'Ocurrió un error al guardar tu sesión. Por favor, inténtalo de nuevo.';
                                                        break;
                                                    case 'error_servidor':
                                                        $mensaje = 'Error en el servidor. Por favor, inténtalo más tarde.';
                                                        break;
                                                    default:
                                                        $mensaje = 'Correo o contraseña incorrectos. Inténtalo nuevamente.';
                                                        break;
                                                }
                                                ?>
                                            ...
                                            <div class="form-container">
                                                <form method="POST" action="valida.php">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <!--      <input type="checkbox" class="custom-control-input" id="customCheck" name="recuerdame" value="1">
                                                ...
                                                <!-- Imagen de Google Play como hipervínculo
                                                <div class="text-center mt-4">
                                                    <a href="https://play.google.com/store/apps/details?id=tu_app_id" target="_blank" rel="noopener noreferrer">
                                                        <img src="../../img/disponiblegoogleplay.png" alt="Disponible en Google Play" class="img-fluid" style="max-width: 200px; height: auto;">
                                                    </a>
                                                </div> -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                                    ...
                                                    <div class="alert alert-danger text-center">
                                                        ...
                                                        switch ($_GET['mensaje'] ?? '') {
                                                            ...
                                                            case 'error_servidor':
                                                                ...
                                                                break;
                                                            default:
                                                                echo 'Error al registrar. El correo ya está en uso o hubo un problema.';
                                                        }
                                                        ?>
                                                    </div>
                                                <?php endif; ?>
                                            ...
                                            <div class="form-container">
                                                <form method="POST" action="registro.php">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-user"
                                                            id="nombre_completo" name="nombre_completo" placeholder="Nombre completo" autocomplete="off" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="email" class="form-control form-control-user"
                                                            id="email_registro" name="email" placeholder="Correo electrónico" autocomplete="off" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="password" class="form-control form-control-user"
                                                            id="contrasena_registro" name="contrasena" placeholder="Contraseña" autocomplete="off" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="password" class="form-control form-control-user"
                                                            id="confirmar_contrasena" name="confirmar_contrasena" placeholder="Confirmar contraseña" autocomplete="off" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-checkbox small">
                                                            ...
                                                            <label class="custom-control-label" for="terminos">
                                                                Acepto los <a href="#" target="_blank" class="text-primary">Términos y Condiciones</a>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-primary btn-user btn-block">
    ...
    <script>
        $(document).ready(function() {
            // Si hay un parámetro 'registro' en la URL, cambiar automáticamente a la pestaña de registro
            const urlParams = new URLSearchParams(window.location.search);
            if (urlParams.get('registro')) {
